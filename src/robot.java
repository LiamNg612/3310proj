...
public class robot {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        String robotVersion = "3.0";
        int listenPort = 3310;

        System.out.println("Robot version " + robotVersion + " (Oct. 24, 2016) started");
        System.out.println("You are reminded to check for the latest available version");
